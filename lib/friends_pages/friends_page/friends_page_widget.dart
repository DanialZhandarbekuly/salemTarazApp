...
import '/friends_pages/choose_type_friendship_page/choose_type_friendship_page_widget.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: StreamBuilder<List<FindPartnerRecord>>(
                      stream: queryFindPartnerRecord(),
                      builder: (context, snapshot) {
                        ...
                        List<FindPartnerRecord> listViewFindPartnerRecordList =
                            snapshot.data!;
                        return ListView.builder(
                          padding: EdgeInsets.zero,
                          shrinkWrap: true,
                          scrollDirection: Axis.vertical,
                          itemCount: listViewFindPartnerRecordList.length,
                          itemBuilder: (context, listViewIndex) {
                            final listViewFindPartnerRecord =
                                listViewFindPartnerRecordList[listViewIndex];
                            return Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  30.0, 20.0, 30.0, 0.0),
                              child: StreamBuilder<UserRecord>(
                                stream: UserRecord.getDocument(
                                    listViewFindPartnerRecord.author!),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                  if (!snapshot.hasData) {
                                    return Center(
                                                              ...
                                                              padding:
                                                                  const EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          0.0),
                                                              child: Text(
                                                                '${listViewFindPartnerRecord.from} - ${listViewFindPartnerRecord.to}',
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'hq8drojk' /* Совместные путешествия */,
                      ),
                      style: FlutterFlowTheme.of(context).bodySmall.override(
                            fontFamily: 'Montserrat',
                            fontSize: 15.0,
                  ...
                  Padding(
                    ...
                    child: StreamBuilder<List<LobbyRecord>>(
                      stream: queryLobbyRecord(),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                        if (!snapshot.hasData) {
                          return Center(
                        ...
                        List<LobbyRecord> listViewLobbyRecordList =
                            snapshot.data!;
                        return ListView.builder(
                          padding: EdgeInsets.zero,
                          shrinkWrap: true,
                          scrollDirection: Axis.vertical,
                          itemCount: listViewLobbyRecordList.length,
                          itemBuilder: (context, listViewIndex) {
                            final listViewLobbyRecord =
                                listViewLobbyRecordList[listViewIndex];
                            return Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  30.0, 20.0, 30.0, 0.0),
                              child: InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed(
                                    'lobbyPage',
                                    queryParameters: {
                                      'lobbyRef': serializeParam(
                                        listViewLobbyRecord.reference,
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                                          ...
                                                          padding:
                                                              const EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      0.0),
                                                          child: Text(
                                                            '${listViewLobbyRecord.from} - ${listViewLobbyRecord.to}',
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            Text(
                                              listViewLobbyRecord.members.length
                                                  .toString(),
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyMedium
                          ...
                          return GestureDetector(
                            ...
                            child: Padding(
                              ...
                              child: SizedBox(
                                ...
                                child: const ChooseTypeFriendshipPageWidget(),
                              ),
                            ),
                          );
                        },
